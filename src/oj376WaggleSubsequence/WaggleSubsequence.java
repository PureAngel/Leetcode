package oj376WaggleSubsequence;
 ...
 * In contrast, [1,4,7,2,5] and [1,7,4,5,5] are not wiggle sequences, t
 * he first because its first two differences are positive and the second 
...
public class WaggleSubsequence {
